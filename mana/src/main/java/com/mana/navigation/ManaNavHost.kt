...
fun ManaNavHost(
    ...
    NavHost(
        ...
        composable<AppLock>(
            ...
            com.mana.ui.screens.AppLockScreen(
                onUnlocked = {
        ...
        composable<Permission>(
            ...
            com.mana.ui.screens.PermissionScreen(
                onPermissionGranted = {
                    navController.navigate(Home) {
        ...
        composable<Settings>(
            ...
            com.mana.ui.screens.settings.SettingsScreen(
        ...
        composable<TransactionDetail>(
            ...
            com.mana.presentation.transactions.TransactionDetailScreen(
        ...
        composable<AddTransaction>(
            ...
            com.mana.presentation.add.AddScreen(
                onNavigateBack = {
                    navController.popBackStack()
                }
            )
        ...
        composable<Rules>(
            ...
            com.mana.ui.screens.rules.RulesScreen(
                onNavigateBack = {
                    navController.popBackStack()
                },
        ...
        composable<CreateRule>(
            ...
            val rulesViewModel: com.mana.ui.viewmodel.RulesViewModel = hiltViewModel()
            ...
            com.mana.ui.screens.rules.CreateRuleScreen(
                onNavigateBack = {
                    navController.popBackStack()
                },
                onSaveRule = { rule ->
        ...
        composable<AccountDetail>(
            ...
            com.mana.presentation.accounts.AccountDetailScreen(
                navController = navController
            )
        }
        ...
        composable<MonthlyBudget>(
            ...
            com.mana.presentation.monthlybudget.MonthlyBudgetScreen(
                onNavigateBack = {
                    navController.popBackStack()
                },
        ...
        composable<MonthlyBudgetSettings>(
            ...
            com.mana.presentation.monthlybudget.MonthlyBudgetSettingsScreen(
                onNavigateBack = {
                    navController.popBackStack()
                }
            )
        ...
        composable<CustomBanks>(
            ...
            com.mana.ui.screens.custombanks.CustomBanksScreen(
        ...
        composable<AddEditBank>(
            ...
            com.mana.ui.screens.custombanks.AddEditBankScreen(
                bankId = route.bankId,
                onNavigateBack = { navController.popBackStack() }
            )
        }
        ...
        composable<BankTemplates>(
            ...
            com.mana.ui.screens.custombanks.BankTemplatesScreen(
                bankId = route.bankId,
                onNavigateBack = { navController.popBackStack() },
        ...
        composable<AddEditTemplate>(
            ...
            com.mana.ui.screens.custombanks.AddEditTemplateScreen(
                bankId = route.bankId,
