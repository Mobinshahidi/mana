...
import com.mana.presentation.common.CurrencyGroupedTotals
import com.mana.presentation.common.CurrencyTotals
...
class TransactionsViewModel @Inject constructor(
    ...
    private val userPreferencesRepository: com.mana.data.preferences.UserPreferencesRepository,
    ...
    fun getReportUrl(transaction: TransactionEntity): String {
        ...
        val encryptedDeviceData = com.mana.utils.DeviceEncryption.encryptDeviceData(context)
