...
import com.mana.data.currency.CurrencyConversionService.TransactionData
...
import com.mana.ui.components.BalancePoint
        ...
        viewModelScope.launch {
            combine(
                ...
                filteredTransactions.forEach { transaction ->
                    ...
                    if (transaction.transactionType == com.mana.data.database.entity.TransactionType.INCOME) {
