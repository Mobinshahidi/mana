...
import com.mana.MainActivity
import com.mana.ManaApplication
import com.mana.R
import com.mana.data.manager.SmsTransactionProcessor
...
class SmsBroadcastReceiver : BroadcastReceiver() {
    ...
    interface SmsBroadcastReceiverEntryPoint {
        ...
        fun transactionRepository(): com.mana.data.repository.TransactionRepository
    }

    companion object {
        private const val TAG = "SmsBroadcastReceiver"
        const val ACTION_EDIT_TRANSACTION = "com.mana.ACTION_EDIT_TRANSACTION"
    ...
    private fun showTransactionNotification(
        ...
        bankName: String,
        category: String,
        repository: com.mana.data.repository.TransactionRepository
    ) {
        receiverScope.launch {
            try {
