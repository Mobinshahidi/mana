package com.mana.ui.screens.analytics

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.mana.data.database.entity.TransactionWithSplits
import com.mana.data.repository.TransactionRepository
import kotlinx.coroutines.ExperimentalCoroutinesApi
import com.mana.presentation.common.TimePeriod
import com.mana.presentation.common.TransactionTypeFilter
import com.mana.presentation.common.getDateRangeForPeriod
        ...
        if (dateRange == null) {
            ...
            transactionRepository.getTransactionsBetweenDates(
                ...
                val dbTransactionType = when (filterState.typeFilter) {
                    ...
                    TransactionTypeFilter.INCOME -> com.mana.data.database.entity.TransactionType.INCOME
                    TransactionTypeFilter.EXPENSE -> com.mana.data.database.entity.TransactionType.EXPENSE
                    TransactionTypeFilter.CREDIT -> com.mana.data.database.entity.TransactionType.CREDIT
                    TransactionTypeFilter.TRANSFER -> com.mana.data.database.entity.TransactionType.TRANSFER
                    TransactionTypeFilter.INVESTMENT -> com.mana.data.database.entity.TransactionType.INVESTMENT
                }
