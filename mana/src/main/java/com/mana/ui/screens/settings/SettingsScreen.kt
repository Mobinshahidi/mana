...
fun SettingsScreen(
    ...
    appLockViewModel: com.mana.ui.viewmodel.AppLockViewModel = hiltViewModel()
) {
    ...
    Surface(
            ...
            Column {
                ...
                ListItem(
                    ...
                    modifier = Modifier.clickable {
                        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/sarim2000/mana-tracker/issues/new/choose"))
        ...
        Spacer(modifier = Modifier.height(Spacing.md))
        Text(
            text = "Mana v${com.mana.BuildConfig.VERSION_NAME}",
            style = MaterialTheme.typography.bodySmall,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
            modifier = Modifier.fillMaxWidth(),
