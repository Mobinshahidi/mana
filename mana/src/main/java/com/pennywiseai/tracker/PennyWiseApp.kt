...
import com.mana.navigation.AppLock
import com.mana.navigation.Home
import com.mana.navigation.Permission
import com.mana.navigation.PennyWiseNavHost
import com.mana.ui.theme.PennyWiseTheme
...
fun PennyWiseApp(
    ...
    LaunchedEffect(appLockUiState.isLocked, appLockUiState.isLockEnabled) {
        if (appLockUiState.isLocked && appLockUiState.isLockEnabled) {
            ...
            if (currentRoute != AppLock::class.qualifiedName &&
                currentRoute != com.mana.navigation.Settings::class.qualifiedName) {
    ...
    LaunchedEffect(editTransactionId) {
        editTransactionId?.let { transactionId ->
            navController.navigate(com.mana.navigation.TransactionDetail(transactionId))
        }
    }
