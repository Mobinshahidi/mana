package com.mana.domain.security
...
title: String = "باز کردن مانا",
subtitle: String = "برای دسترسی به داده‌های هزینه احراز هویت کنید",
description: String = "از بیومتریک یا پین دستگاه استفاده کنید",
onSuccess: () -> Unit,
onError: (String) -> Unit,
onFailed: () -> Unit = {}
) {
