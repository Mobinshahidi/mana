...
-keep class com.mana.data.database.entity.** { *; }
-keep class com.mana.data.database.dao.** { *; }
...
-keep,includedescriptorclasses class com.mana.**$$serializer { *; }
-keepclassmembers class com.mana.** {
    *** Companion;
}
-keepclasseswithmembers class com.mana.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
# Keep data classes
-keep class com.mana.data.model.** { *; }
-keep class com.mana.domain.model.** { *; }
