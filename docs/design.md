...
## Overview
Mana follows Material 3 design principles with a focus on simplicity, clarity, and user-centric design. This document outlines the visual design system, theming approach, and layout guidelines.

## Theme System

### Material You Integration
Mana leverages Android 12+ dynamic color system to create personalized experiences:
