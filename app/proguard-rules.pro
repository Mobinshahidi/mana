...
-keep class com.mana.tracker.data.database.entity.** { *; }
-keep class com.mana.tracker.data.database.dao.** { *; }
...
-keep,includedescriptorclasses class com.mana.tracker.**$$serializer { *; }
-keepclassmembers class com.mana.tracker.** {
    *** Companion;
}
-keepclasseswithmembers class com.mana.tracker.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
# Keep data classes
-keep class com.mana.tracker.data.model.** { *; }
-keep class com.mana.tracker.domain.model.** { *; }
