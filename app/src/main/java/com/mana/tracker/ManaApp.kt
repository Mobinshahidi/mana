...
import com.mana.tracker.navigation.AppLock
import com.mana.tracker.navigation.Home
import com.mana.tracker.navigation.Permission
import com.mana.tracker.navigation.ManaNavHost
import com.mana.tracker.ui.theme.ManaTheme
import com.mana.tracker.ui.viewmodel.AppLockViewModel
...
fun ManaApp(
    ...
    LaunchedEffect(appLockUiState.isLocked, appLockUiState.isLockEnabled) {
        if (appLockUiState.isLocked && appLockUiState.isLockEnabled) {
            ...
            if (currentRoute != AppLock::class.qualifiedName &&
                currentRoute != com.mana.tracker.navigation.Settings::class.qualifiedName) {
    ...
    LaunchedEffect(editTransactionId) {
        editTransactionId?.let { transactionId ->
            navController.navigate(com.mana.tracker.navigation.TransactionDetail(transactionId))
        }
    }
