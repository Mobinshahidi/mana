...
fun SettingsScreen(
    ...
    appLockViewModel: com.mana.tracker.ui.viewmodel.AppLockViewModel = hiltViewModel()
) {
    ...
    Surface(
        ...
        if (unreportedCount > 0) {
            SectionHeader(title = "Help Improve Mana")
            ...
            Column {
                ...
                ListItem(
                    ...
                    modifier = Modifier.clickable {
                        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/Mobinshahidi/mana/issues/new/choose"))
        ...
        Spacer(modifier = Modifier.height(Spacing.md))
        Text(
            text = "Mana v${com.mana.tracker.BuildConfig.VERSION_NAME}",
            style = MaterialTheme.typography.bodySmall,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
            modifier = Modifier.fillMaxWidth(),
    ...
    if (showExportOptionsDialog && exportedBackupFile != null) {
        ...
        val fileName = "Mana_Backup_$timestamp.manabackup"
