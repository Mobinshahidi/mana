package com.mana.tracker.ui.screens.analytics

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.mana.tracker.data.database.entity.TransactionWithSplits
import com.mana.tracker.data.repository.TransactionRepository
import kotlinx.coroutines.ExperimentalCoroutinesApi
import com.mana.tracker.presentation.common.TimePeriod
import com.mana.tracker.presentation.common.TransactionTypeFilter
import com.mana.tracker.presentation.common.getDateRangeForPeriod
import com.mana.tracker.utils.CurrencyUtils
        ...
        if (dateRange == null) {
            ...
            transactionRepository.getTransactionsBetweenDates(
                ...
                val dbTransactionType = when (filterState.typeFilter) {
                    ...
                    TransactionTypeFilter.INCOME -> com.mana.tracker.data.database.entity.TransactionType.INCOME
                    TransactionTypeFilter.EXPENSE -> com.mana.tracker.data.database.entity.TransactionType.EXPENSE
                    TransactionTypeFilter.CREDIT -> com.mana.tracker.data.database.entity.TransactionType.CREDIT
                    TransactionTypeFilter.TRANSFER -> com.mana.tracker.data.database.entity.TransactionType.TRANSFER
                    TransactionTypeFilter.INVESTMENT -> com.mana.tracker.data.database.entity.TransactionType.INVESTMENT
                }
