package com.mana.tracker.data.database
...
import com.mana.tracker.data.database.converter.Converters
import com.mana.tracker.data.database.dao.AccountBalanceDao
import com.mana.tracker.data.database.dao.BudgetDao
import com.mana.tracker.data.database.dao.CategoryBudgetLimitDao
import com.mana.tracker.data.database.dao.CardDao
import com.mana.tracker.data.database.dao.CategoryDao
import com.mana.tracker.data.database.dao.ChatDao
import com.mana.tracker.data.database.dao.ExchangeRateDao
import com.mana.tracker.data.database.dao.MerchantMappingDao
import com.mana.tracker.data.database.dao.RuleApplicationDao
...
import com.mana.tracker.data.database.entity.CategoryBudgetLimitEntity
import com.mana.tracker.data.database.entity.CardEntity
import com.mana.tracker.data.database.entity.CategoryEntity
import com.mana.tracker.data.database.entity.ChatMessage
import com.mana.tracker.data.database.entity.ExchangeRateEntity
import com.mana.tracker.data.database.entity.MerchantMappingEntity
import com.mana.tracker.data.database.entity.RuleApplicationEntity
...
abstract class ManaDatabase : RoomDatabase() {
    ...
    companion object {
         ...
         */
        fun getInstance(context: android.content.Context): ManaDatabase {
         ...
         */
        fun setInstance(database: ManaDatabase) {
            INSTANCE = database
        }
