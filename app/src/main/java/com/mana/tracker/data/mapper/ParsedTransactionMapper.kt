package com.mana.tracker.data.mapper
...
fun ParsedTransaction.toEntity(): TransactionEntity {
    ...
    val entityType = when (type) {
        com.mana.parser.core.TransactionType.INCOME -> TransactionType.INCOME
        com.mana.parser.core.TransactionType.EXPENSE -> TransactionType.EXPENSE
        com.mana.parser.core.TransactionType.CREDIT -> TransactionType.CREDIT
        com.mana.parser.core.TransactionType.TRANSFER -> TransactionType.TRANSFER
        com.mana.parser.core.TransactionType.INVESTMENT -> TransactionType.INVESTMENT
        com.mana.parser.core.TransactionType.BALANCE_UPDATE -> TransactionType.EXPENSE
    }
 ...
 */
fun com.mana.parser.core.TransactionType.toEntityType(): TransactionType {
    return when (this) {
        com.mana.parser.core.TransactionType.INCOME -> TransactionType.INCOME
        com.mana.parser.core.TransactionType.EXPENSE -> TransactionType.EXPENSE
        com.mana.parser.core.TransactionType.CREDIT -> TransactionType.CREDIT
