...
import com.mana.tracker.data.model.ChatContext
import com.mana.tracker.data.preferences.UserPreferencesRepository
import com.mana.tracker.domain.service.LlmService
...
class LlmRepository @Inject constructor(
    ...
    private fun buildSystemPrompt(context: ChatContext): String {
        ...
        return """
        You are Mana AI, a friendly financial assistant helping users track expenses and manage money.
    ...
    suspend fun getFormattedContextForDisplay(): String {
        ...
        return """
        Hi! I'm Mana AI, your financial assistant.
