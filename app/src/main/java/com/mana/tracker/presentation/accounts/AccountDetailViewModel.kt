...
import com.mana.tracker.data.currency.CurrencyConversionService.TransactionData
...
import com.mana.tracker.ui.components.BalancePoint
        ...
        viewModelScope.launch {
            combine(
                ...
                filteredTransactions.forEach { transaction ->
                    ...
                    if (transaction.transactionType == com.mana.tracker.data.database.entity.TransactionType.INCOME) {
