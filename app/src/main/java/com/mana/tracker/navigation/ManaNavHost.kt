package com.mana.tracker.navigation
...
import com.mana.tracker.ui.MainScreen
...
fun ManaNavHost(
    ...
    NavHost(
        ...
        composable<AppLock>(
            ...
            com.mana.tracker.ui.screens.AppLockScreen(
                onUnlocked = {
        ...
        composable<Permission>(
            ...
            com.mana.tracker.ui.screens.PermissionScreen(
                onPermissionGranted = {
                    navController.navigate(Home) {
        ...
        composable<Settings>(
            ...
            com.mana.tracker.ui.screens.settings.SettingsScreen(
        ...
        composable<TransactionDetail>(
            ...
            com.mana.tracker.presentation.transactions.TransactionDetailScreen(
        ...
        composable<AddTransaction>(
            ...
            com.mana.tracker.presentation.add.AddScreen(
                onNavigateBack = {
                    navController.popBackStack()
                }
            )
        ...
        composable<Rules>(
            ...
            com.mana.tracker.ui.screens.rules.RulesScreen(
                onNavigateBack = {
                    navController.popBackStack()
                },
        ...
        composable<CreateRule>(
            ...
            val rulesViewModel: com.mana.tracker.ui.viewmodel.RulesViewModel = hiltViewModel()
            ...
            com.mana.tracker.ui.screens.rules.CreateRuleScreen(
                onNavigateBack = {
                    navController.popBackStack()
                },
                onSaveRule = { rule ->
        ...
        composable<AccountDetail>(
            ...
            com.mana.tracker.presentation.accounts.AccountDetailScreen(
                navController = navController
            )
        }
        ...
        composable<MonthlyBudget>(
            ...
            com.mana.tracker.presentation.monthlybudget.MonthlyBudgetScreen(
                onNavigateBack = {
                    navController.popBackStack()
                },
        ...
        composable<MonthlyBudgetSettings>(
            ...
            com.mana.tracker.presentation.monthlybudget.MonthlyBudgetSettingsScreen(
                onNavigateBack = {
                    navController.popBackStack()
                }
            )
