...
class NotificationActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_DELETE_TRANSACTION = "com.mana.tracker.ACTION_DELETE_TRANSACTION"
        const val ACTION_CONFIRM_TRANSACTION = "com.mana.tracker.ACTION_CONFIRM_TRANSACTION"
        const val ACTION_CHANGE_CATEGORY = "com.mana.tracker.ACTION_CHANGE_CATEGORY"
    ...
    private fun deleteTransaction(context: Context, transactionId: Long, notificationId: Int) {
        receiverScope.launch {
            try {
                val database = ManaDatabase.getInstance(context)
