package com.mana.tracker.receiver
...
import com.mana.tracker.MainActivity
import com.mana.tracker.ManaApplication
import com.mana.tracker.R
import com.mana.tracker.data.manager.SmsTransactionProcessor
...
class SmsBroadcastReceiver : BroadcastReceiver() {
    ...
    interface SmsBroadcastReceiverEntryPoint {
        ...
        fun transactionRepository(): com.mana.tracker.data.repository.TransactionRepository
    }

    companion object {
        private const val TAG = "SmsBroadcastReceiver"
        const val ACTION_EDIT_TRANSACTION = "com.mana.tracker.ACTION_EDIT_TRANSACTION"
            ...
            try {
                ...
                if (result.success && result.transactionId != null) {
                    ...
                    if (!isAppInForeground(context)) {
                        ...
                        val parser = com.mana.parser.core.bank.BankParserFactory.getParser(sender)
    ...
    private fun isAppInForeground(context: Context): Boolean {
        return try {
            val application = context.applicationContext as? ManaApplication
    ...
    private fun showTransactionNotification(
        ...
        bankName: String,
        category: String,
        repository: com.mana.tracker.data.repository.TransactionRepository
    ) {
        receiverScope.launch {
            try {
