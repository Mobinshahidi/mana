...
Mana AI is built with privacy as the core principle. We believe your financial data should remain yours alone.
...
- Data is only accessible to Mana AI app
...
Mana AI is fully open source:
- Review our code at [GitHub](https://github.com/Mobinshahidi/mana)
- Verify our privacy claims yourself
- Contribute to make it even better

## Children's Privacy

Mana AI is not directed at children under 13. We do not knowingly collect information from children.
...
- Open an issue on [GitHub](https://github.com/Mobinshahidi/mana/issues)
...
*Mana AI - Privacy-first expense tracking with on-device AI*